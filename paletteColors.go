...
var (
    ...
    // werden. Diese Namen werden vom Programm 'palgen' gelesen und zur
    // Erstellung des Files paletteNames.go verwendet. Die Namen der
    // Farblisten sind nicht exportiert (d.h. beginnen mit Kleinbuchstaben)
    // und muessen mit 'Colors' enden.
    ...
    fadeYellowColors = []LedColor{
        {0x00, 0x00, 0x00, 0xFF},
        {0xff, 0xff, 0x00, 0xFF},
    }
    fadeCyanColors = []LedColor{
        {0x00, 0x00, 0x00, 0xFF},
        {0x00, 0xff, 0xff, 0xFF},
    }
    fadeMagentaColors = []LedColor{
        {0x00, 0x00, 0x00, 0xFF},
        {0xff, 0x00, 0xff, 0xFF},
    }
